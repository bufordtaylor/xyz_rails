...
events_attrs = [
  {name: "TechCrunch 50", category: "tech", latitude: 51.501000, longitude: -0.142000, available: false},
  ...
  {name: "Matrix", category: "tech", latitude: 51.538333, longitude: -0.013333, available: true},
